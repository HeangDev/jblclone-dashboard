        ...
        <>
            <div className="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                ...
                <div className="sa-menu-wrapper d-flex align-items-center justify-content-between">
                    <button type="button" className="navbar-toggler navbar-toggler align-self-center"><i class="bi bi-list"></i></button>
                    <ul className="navbar-nav sa-nav-right">
                        <li className="nav-item dropdown">
                            <button type="button" className="nav-link sa-indicator d-flex align-items-center justify-content-center"><i class="bi bi-bell"></i></button>
                        ...
                        <li className="nav-item sa-nav-logout dropdown">
                            <button type="button" className="nav-link sa-indicator d-flex align-items-center justify-content-center"><i class="bi bi-box-arrow-right"></i></button>
                            <div className="dropdown-menu dropdown-menu-right navbar-dropdown preview-list">
